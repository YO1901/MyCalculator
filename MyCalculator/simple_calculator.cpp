...
/// simple_calculator.cpp: определяет поведение классов для приложения.
///
...
/// Единственный объект CMyCalculatorApp

CMyCalculatorApp theApp;


/// Инициализация CMyCalculatorApp
